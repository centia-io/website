...
- Indexes: A standard GiST index on the geometry column is created by the platform. If you append, existing indexes are preserved; new indexes are not recreated unless needed.
