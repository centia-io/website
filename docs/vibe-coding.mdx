...
:::info
The `API_BASE_URL` environment variable is optional when using Centia Cloud. Set it when using a self-hosted deployment.
...
In Claude Code, copy `AGENT.md` to `CLAUDE.md`, because Claude Code automatically reads `CLAUDE.md`.
