...
To import from a URL on a recurring schedule instead, use the [Scheduler](./scheduler.mdx).
...
<Tabs>
  <TabItem value="webapp" label="Web App">
    ![Upload files in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
  </TabItem>
