...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ...
        ```bash
        centia column get "myschema" "mytable" "id"
        ```
...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ...
        ```bash
        centia table add "myschema" "mytable" "id" integer
        ```
...
<Tabs>
    ...
    <TabItem value="cli" label="CLI" >
        ```bash title="rename"
        centia schema rename "myschema" "mytable" "id" "id2"
        ```
        ```bash title="type"
        centia schema type "myschema" "mytable" "id" int8
        ```
        ```bash title="nullable"
        centia schema nullable "myschema" "mytable" "id" true
        ```
        ```bash title="default"
        centia schema default "myschema" "mytable" "id" 100
        ```
    </TabItem>
</Tabs>
...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ```bash
        centia column drop "myschema" "mytable" "id"
        ```
    </TabItem>
</Tabs>
