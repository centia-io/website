...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Add sequence in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![View sequences in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Update sequence in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
        ```http
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Delete sequence in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
        ```http
