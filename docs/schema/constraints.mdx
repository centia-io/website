...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ...
        ```bash
        centia constraint get "myschema" "mytable" "my-unique-constraint"
        ```
...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ...
        ```bash
        centia constraint add "myschema" "mytable" "id" unique "my-unique-constraint"
        ```
...
<Tabs>
    ...
    <TabItem value="cli" label="CLI">
        ...
        centia constraint drop "myschema" "mytable" "my-unique-constraint"
        ```
