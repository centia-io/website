...
Every table with a geometry column is a **layer** that can be rendered through [WMS](../ogc/services.mdx). The Layer API controls how a layer is drawn: its rendering properties, and its **classes**, which in turn contain **styles** and **labels**:
