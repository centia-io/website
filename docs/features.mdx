...
:::note
Reading requires a key — the Feature API does not read whole collections. Use the [SQL API](./statement.mdx), the [OGC API](./ogc/api.mdx) or [OGC WFS](./ogc/services.mdx) to query collections.
:::
