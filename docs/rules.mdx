...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Create rule in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![View rules in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Update rule in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
...
<Tabs>
    <TabItem value="webapp" label="Web App">
        ![Delete rule in the Centia Web App](/img/screenshots/webapp-placeholder.svg)
    </TabItem>
    <TabItem value="http" label="HTTP" default>
