...
Execute parameterized SQL against Centia.io.
...
Call JSON‑RPC methods exposed by Centia.io.
...
### Get JSON-RPC TypeScript interfaces
...
```
And `/api/v4/interfaces` will know return a typed interface:
