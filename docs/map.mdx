...
| `extent` | Map extent as `[minx, miny, maxx, maxy]` in EPSG:4326. Sets the initial extent of the map **and** the schema's bounding box in the [OGC services](./ogc/services.mdx). Nullable. |
