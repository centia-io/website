...
**query** can be a schema qualified relation name, a schame name, a tag in the form tag:name or combination of the three separated by comma.
...
Field metadata describes individual columns within the relation.
