                    ...
                    <section className={`container ${styles.guidesSection}`}>
                        ...
                        <div className={styles.guidesGrid}>
                            <div className={styles.guideCard}>
                                ...
                                <div>
                                    <Link className="button button--sm button--primary" to="/docs/start" onClick={() => trackCtaClick('cta_console_start_guide_click', {location: 'console_card_start'})}>Open guide</Link>
                                </div>
                            </div>
                            <div className={styles.guideCard}>
                                <h3>Vibe coding</h3>
                                ...
                                <div>
                                    <Link className="button button--sm button--primary" to="/docs/vibe-coding" onClick={() => trackCtaClick('cta_console_vibe_coding_click', {location: 'console_card_vibe'})}>Get started</Link>
                                </div>
                            </div>
                            <div className={styles.guideCard}>
                                <h3>Realtime</h3>
                                ...
                                <div>
                                    <Link className="button button--sm button--primary" to="/docs/realtime" onClick={() => trackCtaClick('cta_console_realtime_click', {location: 'console_card_realtime'})}>Learn more</Link>
                                </div>
                            </div>
                            <div className={styles.guideCard}>
                                <h3>OAuth</h3>
                                ...
                                <div>
                                    <Link className="button button--sm button--primary" to="/docs/oauth" onClick={() => trackCtaClick('cta_console_oauth_click', {location: 'console_card_oauth'})}>Set up auth</Link>
                                </div>
                            </div>
                        </div>
                    </section>
